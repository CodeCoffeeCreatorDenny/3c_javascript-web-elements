...
function getSavedColumns() {
  if (localStorage.getItem('backlogItems')) {
    ...
    backlogListArray = [
      'create 5 games on Python',
      'create 3 project on ReactJS from course "React from zero"',
      'create some projects on React+Redux from course',
    ];
    progressListArray = [
      'create 9 web elements on JavaScript',
      'create 9 games on JavaScript',
    ];
    completeListArray = [
      'Пройти курс по хукам в ReactJS',
      'Курс по продакт-менеджменту',
    ];
    onHoldListArray = [
      'Computer Networks course',
      'Прочитать книгу по алгоритмам: Бхаргава "Грокаем алгоритмы"',
    ];
  }
}
